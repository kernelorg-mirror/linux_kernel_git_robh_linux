...
static int as3711_backlight_parse_dt(struct device *dev)
{
	...
	if (fb) {
		...
		if (of_property_present(bl, "su2-feedback-voltage")) {
			pdata->su2_feedback = AS3711_SU2_VOLTAGE;
			count++;
		}
		if (of_property_present(bl, "su2-feedback-curr1")) {
			pdata->su2_feedback = AS3711_SU2_CURR1;
			count++;
		}
		if (of_property_present(bl, "su2-feedback-curr2")) {
			pdata->su2_feedback = AS3711_SU2_CURR2;
			count++;
		}
		if (of_property_present(bl, "su2-feedback-curr3")) {
			pdata->su2_feedback = AS3711_SU2_CURR3;
			count++;
		}
		if (of_property_present(bl, "su2-feedback-curr-auto")) {
		...
		count = 0;
		if (of_property_present(bl, "su2-fbprot-lx-sd4")) {
			pdata->su2_fbprot = AS3711_SU2_LX_SD4;
			count++;
		}
		if (of_property_present(bl, "su2-fbprot-gpio2")) {
			pdata->su2_fbprot = AS3711_SU2_GPIO2;
			count++;
		}
		if (of_property_present(bl, "su2-fbprot-gpio3")) {
			pdata->su2_fbprot = AS3711_SU2_GPIO3;
			count++;
		}
		if (of_property_present(bl, "su2-fbprot-gpio4")) {
		...
		count = 0;
		if (of_property_present(bl, "su2-auto-curr1")) {
			pdata->su2_auto_curr1 = true;
			count++;
		}
		if (of_property_present(bl, "su2-auto-curr2")) {
			pdata->su2_auto_curr2 = true;
			count++;
		}
		if (of_property_present(bl, "su2-auto-curr3")) {
