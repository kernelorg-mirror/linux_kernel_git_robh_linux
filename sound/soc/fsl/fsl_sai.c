...
static int fsl_sai_probe(struct platform_device *pdev)
{
	...
	if (of_property_present(np, "fsl,sai-synchronous-rx") &&
	    of_property_present(np, "fsl,sai-asynchronous")) {
	...
	} else if (of_property_present(np, "fsl,sai-asynchronous")) {
	...
	if (of_property_present(np, "fsl,sai-mclk-direction-output") &&
